...
class EnvironementVect():
    ...
    def reset(self):
        ...
        return self.game.get_dataframe(), 0, self.game.is_done(), self.game.lives
    ...
    def step(self, action):
        ...
        return self.game.get_dataframe(), reward, self.game.is_done(), self.game.lives
