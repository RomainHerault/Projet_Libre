...
class DQNAgent:
    def __init__(self, action_size):
        ...
        self.no_op_steps = 30
        # Create model and target model and initialize target model
    ...
    # Manually define optimization functions to use Huber Loss
    def optimizer(self):
...
if __name__ == "__main__":
    ...
    for e in range(EPISODES):
        ...
        while not done:
            ...
            # Store and learn samples <s, a, r, s'> in replay memory
